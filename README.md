...
![](https://github.com/InboardDelta/DHT22/blob/main/LIBRERIA.png?raw=true)

3. Hacer la conexion de **DHT22** con la **ESP32** como se muestra en la siguente imagen.

![](https://github.com/InboardDelta/DHT22/blob/main/CONEXION.png?raw=true)
...
![](https://github.com/InboardDelta/DHT22/blob/main/FUNCIONANDO.png?raw=true)

# Comentarios del alumno
Se comenzó a familiarizarse con los primeros programas **Visual Studio Code** y plataformas [WOKWI](https://https://wokwi.com/), [GITHUB](https://github.com/), la practica nos ayudo a desarrollar las primeras habilidades. 
